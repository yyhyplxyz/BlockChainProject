...
peer chaincode invoke -C mychannel -n assets -c '{"Args":["assetEnroll", "asset1", "asset1", "metadata", "user1"]}'
peer chaincode invoke -C assetschannel -n assets -c '{"Args":["userRegister", "user2", "user2"]}'
peer chaincode invoke -C mychannel -n assets -c '{"Args":["assetExchange", "user1", "asset1", "user2"]}'
